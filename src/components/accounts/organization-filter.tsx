...
import { customerStatuses } from "@/lib/organizations";
...
export function organizationFilterCount(filters: OrganizationFilters) {
...
export function OrganizationFilter({
  ...
  const active = organizationFilterCount(filters);
        ...
        >
          ...
          <FilterSelect
            ...
            onChange={(connectionStatus) =>
              onChange({ ...filters, connectionStatus })
            }
          />
          <FilterSelect
            ...
            onChange={(customerStatus) =>
              onChange({ ...filters, customerStatus })
            }
          />
          <FilterSelect
            label="Assessment"
            ...
            onChange={(assessmentStatus) =>
              onChange({ ...filters, assessmentStatus })
            }
          />
          {active ? (
            <button
              ...
              onClick={() => onChange(emptyOrganizationFilters)}
            >
              Clear filters
            </button>
          ) : null}
