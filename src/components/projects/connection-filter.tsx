...
import { projectPlatforms } from "@/lib/db/types";
import { platformLabel } from "@/lib/platforms";

const statusFilters = ["CONNECTED", "DISCONNECTED", "ERROR"] as const;
...
const scopeFilters = ["attached", "unattached"] as const;
...
export const emptyConnectionFilters: ConnectionFilters = {
  platformType: "",
  status: "",
  scope: "",
};

export function connectionFilterCount(filters: ConnectionFilters) {
...
export function ConnectionFilter({
  ...
  const active = connectionFilterCount(filters);
      ...
      {open ? (
        ...
        >
          <FilterSelect
            ...
            onChange={(platformType) => onChange({ ...filters, platformType })}
          />
          <FilterSelect
            label="Status"
          ...
          {active ? (
            <button
              ...
              onClick={() => onChange(emptyConnectionFilters)}
            >
              Clear filters
            </button>
          ) : null}
